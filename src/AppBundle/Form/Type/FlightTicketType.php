...
class FlightTicketType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder->add("pnr", "text", array("label" => "PNR", "attr" => array("placeholder" => "Passenger Name Record")))
                ...
                ->add("agent", "entity", array('placeholder' => 'Direct Customer', 'required' => false, 'class' => 'AppBundle:Agent', "choice_label" => function($agent) {
                        return "[" . $agent->getRegNo() . "] " . $agent->getAgentFullName("S,f o");
                    }))
